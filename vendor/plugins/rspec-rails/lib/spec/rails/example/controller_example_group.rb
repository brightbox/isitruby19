  ...
  module Rails
    module Example
      ...
      class ControllerExampleGroup < FunctionalExampleGroup
        ...
        #ÊPerform a pseudo HTTP GET, performing any code in the block beforehand.  This is to allow you to set up expectations on your mocks whilst keeping the code readable.   
        # For example: 
        ...
        #ÊPerform a pseudo HTTP POST, performing any code in the block beforehand.  This is to allow you to set up expectations on your mocks whilst keeping the code readable.   
        def on_posting_to page, parameters = {}
          yield if block_given?
          post page, parameters
        end
        
        #ÊPerform a pseudo HTTP PUT, performing any code in the block beforehand.  This is to allow you to set up expectations on your mocks whilst keeping the code readable.   
        def on_putting_to page, parameters = {}
          yield if block_given?
          put page, parameters
        end
        
        #ÊPerform a pseudo HTTP DELETE, performing any code in the block beforehand.  This is to allow you to set up expectations on your mocks whilst keeping the code readable.   
